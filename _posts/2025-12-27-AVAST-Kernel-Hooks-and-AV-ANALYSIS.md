...
This method is commonly known as InfinityHook (originally an offensive technique discovered around 2018–2019, later repurposed by some EDR/AV vendors for defensive syscall monitoring, see [InfinityHook](https://github.com/everdox/InfinityHook)).
...
![First Image](/images/22.png)



![First Image](/images/23.png)
...
![First Image](/images/24.png)

![First Image](/images/25.png)
...
---
For Live Examining, the webinar video is on [YOUTUBE](https://youtu.be/_6sY2QGUHBA) :D
